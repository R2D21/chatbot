...
typedef enum { UNKNOWN, QUIT, FERMER, SAVE, DELAY, HELP, SPEECH, VOICELIST, VOICE, BRAIN, QUIET} COMMAND_WORDS;
...
static COMMAND command[] = {
    ...
    { { 4, "FERMER" }, "fermers the program *without* saving MegaHAL's brain", FERMER },
